...
Vendordetails user2=(Vendordetails)hs.getAttribute("user2");
hs.setAttribute("user2", user2);
...
%>
    ...
    <input type="text" placeholder="Enter your ID" name="Vendor_Id"  value="<%=user2.getVendor_Id()%>" readOnly>

 <label for="Vendor_UserId">Vendor User_ID</label>
    <input type="text" placeholder="Enter your ID" name="Vendor_UserId" value="<%=user2.getVendor_UserId()%>">

    <label for="fname">First Name</label>
    <input type="text" placeholder="Enter First Name in Capital Letters" name="fname" value="<%=user2.getfName2() %>">

    <label for="lname">Last Name</label>
    <input type="text" placeholder="Enter Last Name" name="lname" value="<%=user2.getlName2()%>">

    <label for="age">Age</label>
    <input type="text" placeholder="Enter Age" name="age" value="<%=user2.getAge2()%>" >

    <label for="gender">Gender</label>
    <select name="gender" placeholder="Gender" value="<%=user2.getGender2()%>">
    ...
    <input type="text" placeholder="Enter Contact Number" name="contactNum" value="<%=user2.getContactNo2() %>" >

    <label for="contactnumber">Address</label><br>
    <input  type="text" placeholder="Enter your address" name="Address"style=" overflow: scroll;" value="<%=user2.getAddress()%>">
    <br>
    <label for="City">City</label>
    <input type="text" placeholder="Enter city name" name="City" value="<%=user2.getCity()%>">

    <label for=" Zip_Code">Zip Code</label>
    <input type="text" placeholder="Enter zip code" name="Zip_Code" value="<%=user2.getZipcode()%>">

    <label for=" Landline">Landline</label>
    <input type="text" placeholder="Enter Landline number" name="Landline" value="<%=user2.getLandline()%>">

    <label for=" Email">Email</label>
    <input type="text" placeholder="Enter your Email" name="Email" value="<%=user2.getEmail() %>">

    <label for="Other_Contact_info">Detailed Contact info</label>
    <input type="text" placeholder="Other Contact info" name="Other_Contact_info" value="<%=user2.getOther()%>">

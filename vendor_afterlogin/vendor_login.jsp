...
<form name="RegForm" action="V_LoginFilter.do"  method="post"  style="border:0px solid #ccc; opacity:2" ;>
  <div class="container">
       <label for="lname">Vendor Id</label>
    <input type="text" name="username" placeholder="Vendor_id"  required>
     <label for="lname">Password</label>
        <input type="password" name="password" placeholder="Password" required>
       
    <div class="clearfix">
     <button type="submit" class="signupbtn" onclick="return G1()"><b>Login</b></button>
      <button type="reset" class="cancelbtn " onclick=" location.href='index.jsp'"><b>Return to home</b></button>

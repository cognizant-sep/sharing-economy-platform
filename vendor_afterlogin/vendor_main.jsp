...
//Vendordetails user=(Vendordetails)hs.getAttribute("user");
...
//Vendordetails vd1=(Vendordetails)hs.getAttribute("vd");
//System.out.println("userdetails checked");
//System.out.println("userd");
//System.out.println(vd.getVendor_Id());
//System.out.println(vd1.getVendor_Id());
...
<strong><center>Welcome Vendor Id: <%=user.getVendor_UserId() %></center></strong><br><br>
    ...
    <div id="upd">
    <form name="RegForm" action="Vendor_detail.do"  method="post"  style="border:0px solid #ccc; opacity:2" ;>
    <div class="container">
     <br><br>
...
<select id="product" onchange="form1SelectCheck(this);" placeholder="Choose Product" name="choose">
 ...
 <label for="Vendor_UserId">Vendor ID</label>
    <input type="text" placeholder="Enter your ID" name="Vendor_UserId" value="<%=user.getVendor_UserId()%>" readonly>
...
<select id="product" onchange="form1SelectCheck(this);" placeholder="Choose Product">
            ...
            <option value="Tables">Tables</option>
            <option value="Wardrobes">Wardrobes</option>
            <option value="another">Add other category...</option>
</select>
</div>
...
<div id="service1formDivCheck" style="display:none;">
<label for="pro">New category</label>
<input type="text" placeholder="Enter the new category..." name="new_cats" >
<button value="ad" type="submit" class="signupbtn" onclick="form2SelectCheck(this);"><b>Add</b></button>
</div>
</form>
</div>
